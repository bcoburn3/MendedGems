package com.bcoburn3.mendedgems.common.item;
...
import com.bcoburn3.mendedgems.common.misc.GemTier;
...
@Optional.Interface(iface = "baubles.api.IBauble", modid = "baubles")
    public class ItemGem extends Item implements IBauble {
        ...
        public ItemGem() {
            this.setRegistryName(new ResourceLocation(MendedGems.MOD_ID, "mended_gem"));
        ...
        public String getItemStackDisplayName(ItemStack stack) {
            ...
            String prefix = MendedGems.proxy.localize("tier.mendedgems.tier_" + meta);
        ...
        public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
            ...
            tooltip.add(TextFormatting.GRAY + I18n.format("tooltip.mendedgems.mended_gem", cooldown / 20D));
        }
